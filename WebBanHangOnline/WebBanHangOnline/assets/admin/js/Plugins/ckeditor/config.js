...
CKEDITOR.editorConfig = function( config ) {
    ...
    config.filebrowserUploadUrl = '/assets/admin/js/plugins/ckfinder/core/connector/asp/connector.asp?command=QuickUpload&type=Files';
    config.filebrowserImageUploadUrl = '/Images';
    config.filebrowserFlashUploadUrl = '/assets/admin/js/plugins/ckfinder/core/connector/asp/connector.asp?command=QuickUpload&type=Flash';
